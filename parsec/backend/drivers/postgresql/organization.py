...
from parsec.backend.drivers.postgresql.tables import t_organization, q_organization
...
class PGOrganizationComponent(BaseOrganizationComponent):
    ...
    async def bootstrap(
        ...
        async with self.dbh.pool.acquire() as conn, conn.transaction():
            ...
            try:
                await self.user_component._create_user(conn, organization_id, user, first_device)
